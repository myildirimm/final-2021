...
class TrajectoryData(MsgpackMixin):
    ...
    is_lane_changing_model_allowed = False
    lane_change_direction = 0
    def __init__(self, set_speed_in_kmh = 0.0, duration_in_seconds = 0.0, duration_in_meters = 0.0, is_lane_changing_model_allowed = False, lane_change_direction = 0):
        self.set_speed_in_kmh = set_speed_in_kmh
        self.duration_in_seconds = duration_in_seconds
        self.duration_in_meters = duration_in_meters
        self.is_lane_changing_model_allowed = is_lane_changing_model_allowed
        self.lane_change_direction = lane_change_direction

class RelativeTrajectory(MsgpackMixin):
    relative_actor_id = -1
    set_speed_in_kmh = 0.0
    distance_to_actor = 0.0
    is_lane_changing_model_allowed = False
    is_acc_enabled = False
    lane_change_direction = 0
    def __init__(self, relative_actor_id = -1, set_speed_in_kmh = 0.0, distance_to_actor = 0.0, is_lane_changing_model_allowed = False, is_acc_enabled = False, lane_change_direction = 0):
        self.relative_actor_id = relative_actor_id
        self.set_speed_in_kmh = set_speed_in_kmh
        self.distance_to_actor = distance_to_actor
        self.is_lane_changing_model_allowed = is_lane_changing_model_allowed
        self.is_acc_enabled = is_acc_enabled
        self.lane_change_direction = lane_change_direction
